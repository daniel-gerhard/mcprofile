...
can be used as a goodness-of-fit criterion. To estimate a coefficient vector $\hat{\beta}_{j}$ an iteratively re-weighted least squares algorithm can be applied for finding the minimum of the deviance function. A more detailed introduction can be found in McCullagh and Nelder (1989).
